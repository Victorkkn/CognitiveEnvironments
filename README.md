...
Este projeto foi desenvolvido como parte do trabalho prático da disciplina **[Cognitive Environments / Cloud AI Services]**, com o objetivo de validar a identidade de um usuário a partir de **três imagens**:
...
```bash
git clone https://github.com/seu-usuario/validador-identidade.git
cd validador-identidade
```
